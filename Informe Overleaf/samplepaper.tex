...
A continuación, se adjunta los currículum vitae como parte de la documentación integral de este módulo, demostrando la aplicación práctica de los estilos de edición aprendidos.
...
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{CV_Pilar_Mujica.pdf}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{CV_Rocio_Martinez.pdf}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{CV_Sara_Kemelmajer.pdf}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{CV_Caterina_Dinnocenzo.pdf}
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{CV_Lucas_Segura.pdf}
